...
DVE.Graph.prototype.update_sidebar = function (interventions, type) {
  ...
  interventions.forEach(function(d,i){
    ...
    $(' ul#added-'+type+'-interventions').append('<li class="animated flash"><span class="fa fa-pencil not-active" data-index="'+i.toString()+'" data-id="'+d.id+'"></span><span class="added-title">'+d.title+'</span> - <span class="added-description">'+d.description+'</span><span class="added-dates">(<span class="added-date-start">'+start+'</span> - <span class="added-date-end">'+end+'</span>)</span></li>');
  });
